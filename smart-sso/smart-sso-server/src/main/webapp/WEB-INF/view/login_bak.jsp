	...
	<body class="login-layout">
	      <%-- <div id="banner">
            <div class="widthLimit">
              <a href="http://www.huaweicloud.com/?locale=zh-cn" class="ng-scope">
                  <img id="logo" src="${_staticPath}/custom/assets/favicon.png">
              </a>
              <span id="bannerQuickLink" class="ng-scope">
                  <a class="homepageLink ng-binding" href="http://www.huaweicloud.com/?locale=zh-cn">首页</a>
                  <a class="homepageLink ng-binding" href="http://support.huaweicloud.com/">帮助中心</a>
                  <a class="homepageLink ng-scope ng-binding" href="https://portal.huaweicloud.com/ydcomm">云社区</a>
                  <span id="languageSwitch">
                          <img style="width:18px;" src="/authui/public/custom/images/e8bbe5d.loginLanguage-zh.png">
                          <span class="ng-binding">中国站</span>
                          <!--<div id="triangle"></div>-->
                  </span>
               </span>

              <!--国际站&&国内站语言类型 -->
              <!-- ngIf: !model.styleOfSite -->
              <ul id="loginPageLanguages" style="display:none;padding-left:10px;opacity: 94%;" class="ng-scope">
                  <!-- ngRepeat: language in model.loginPageLanguages -->
                  <li class="sel-lang ng-scope ng-binding" id="ch-zh-cn">中国站-简体中文</li>
                  <!-- end ngRepeat: language in model.loginPageLanguages -->
                  <li class="sel-lang ng-scope ng-binding" id="ch-en-us">中国站-English</li>
                  <!-- end ngRepeat: language in model.loginPageLanguages -->
                  <li class="sel-lang ng-scope ng-binding" id="hk-zh-cn">International-简体中文</li>
                  <!-- end ngRepeat: language in model.loginPageLanguages -->
                  <li class="sel-lang ng-scope ng-binding" id="hk-en-us">International-English</li>
                  <!-- end ngRepeat: language in model.loginPageLanguages -->
              </ul><!-- end ngIf: !model.styleOfSite -->
