				...
				<div class="col-sm-9">
					<div class="clearfix help-validate">
						<div class="input-group">
							<textarea id="_description" name="description" class="autosize-transition form-control" placeholder="描述" rows="6" cols="60">${app.description}</textarea>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="clearfix help-validate">
						<div>
							<label class="line-height-1 blue">
								<input name="enabled" value="true" type="radio" class="ace" ${app.enabled ? 'checked="checked"' : ''}/>
						...
						<div>
							<label class="line-height-1 blue">
								<input name="enabled" value="false" type="radio" class="ace" ${!app.enabled ? 'checked="checked"' : ''}/>
